...
```json
"features": {
    "ghcr.io/ryanmsnyder/devcontainer-features/neovim-essentials:0": {}
}
```
...
_Note: This file was auto-generated from the [devcontainer-feature.json](https://github.com/ryanmsnyder/devcontainer-features/blob/main/src/neovim-essentials/devcontainer-feature.json).  Add additional notes to a `NOTES.md`._
